    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Unidade de Medida</small></h1>
            </div>
        </div>
        ...
        <div class='container-fluid'>
            <form method='POST' action='controller/unidade_medida_controller.php'>
                ...
                <div class='full-reset row representative-resul'>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        ...
                        <input type='text' class='form-control text-center  tooltips-general' name='descricao'
                            ...
                            title='Descrição da Unidade de Meida' required>
                        <br>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        ...
                        <div class='group-material'>
                            <input type='text' class='form-control text-center  tooltips-general' name='abrev'
                                id='abrev' data-toggle='tooltip' data-placement='top'
                                title='Abreviação do tipo de unidade de medida' required>
                        </div>
                    </div>
        ...
        <center>
            <div class="alert alert-secondary  col-md-12" role="alert" align="center">
                <h1>
                    <font color="black">Unidade de Medidas Cadastradas</font>
                </h1>
            </div>
        </center>
        ...
        <section id="direita">
            ...
            <table id="example" class="table table-striped col-md-12" align="center"
                ...
                <?php
                    $unidadeMedida = unidademedida::consultar("SELECT * FROM unidademedida WHERE ativo = 1");
                    ?>
                <tbody>

                    <?php
                        foreach ($unidadeMedida as $listarUnidademedida) {
                        ?>
                    <tr>
                        <th scope="row"><?php echo $listarUnidademedida['id']; ?></th>
                        <td><?php
                                    echo $listarUnidademedida['descricao'];
                                    ?>
                        <td><?php
                                    echo $listarUnidademedida['abrev'];
                                    ?></td>
                        <td>
                            <a
                                href="cadastrar_unidade_medida.php?editar=true&idEditar=<?php echo $listarUnidademedida['id']; ?>">
                                <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                                </button></a>
                        </td>
                        <td>
                            <a
                                href="controller/unidade_medida_controller.php?deletar=true&id=<?php echo $listarUnidademedida['id']; ?>">
        ...
        <?php
            ...
            $unidadeMedida = unidademedida::consultar("SELECT * FROM unidademedida WHERE ativo = 1 AND id = '$idEditar'");

            foreach ($unidadeMedida as $ttt) {
            ?>
                            ...
                            <div class="row">
                                <div class='col-sm-6'>
                                    ...
                                    <input type='text' value="<?php echo $ttt['descricao']; ?>"
                                        ...
                                        id='descricao' data-toggle='tooltip' data-placement='top'
                                        title='Nome do tipo do material' required>
                                </div>
                                <div class='col-sm-6'>

                                    <label>Abrev</label>
                                    <input type='text' value="<?php echo $ttt['abrev']; ?>"
                                        class='form-control text-center  tooltips-general' name='abrevAtualizado'
                                        id='descricao' data-toggle='tooltip' data-placement='top'
                                        title='Nome do tipo do material' required>
                                </div>
                            </div><!-- row -->
