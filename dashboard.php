...
include_once 'library/Consulta.php';
  ...
  //Excluyi uma saida de consumo de Material reduzindo do estoque
  if (isset($_POST['excluir-consumo'])) {
    ...
    $tabela     = "saida";
    $campos     = "status='2',rg_status='$rguser',obs='$obs'";
    $condicion  = "id_saida='$idsaida'";
    if (consultasSQL::UpdateSQL($tabela, $campos, $condicion)) {

      $estoque      = mysqli_fetch_array(ejecutarSQL::consultar("SELECT qnt_atual from entrada where id_entrada='$identrada'"))[0];
  ...
  <script type="text/javascript">
    ...
    function excluirConsumo(id, qnt, idsaida) {
      $("#identrada").val(id);
      $("#qnt").val(qnt);
      $("#idsaida").val(idsaida);
      $('#excluir-consumo').modal('show');
    }
  </script>
            ...
            <div class="col-xs-12 col-sm-3">
              ...
              <div class="group-material">
                <select class="selectpicker form-control" data-size="20" data-live-search="true" name="idmaterial" id="idmaterial" onChange="javascript: ValidaMat();">
                  <option value="">&nbsp;&nbsp; - -TODOS- - </option>
                  <?php
                  $querymaterial  = ejecutarSQL::consultar("SELECT * FROM material order by descricao asc");
    ...
    <div>
      ...
      <div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse multi-collapse in text-center" id="saidas">
          <h1 class="all-tittles"><small><a href="dashboard.php" title="Clique para limpar os filtros!"> PEDIDOS</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "TOTAL : " . $qntsaida; ?></small></h1>
          <div class="table-responsive">
            <div class="div-table" style="margin:0 !important;">
              <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                        ...
                        <div class="div-table" style="margin:0 !important;<?php echo $style; ?>">
                          <div class="div-table-row div-table-row-list">
                            ...
                            <div class="div-table-cell" style="width: 5%;">
                              ...
                              if ($saidastotal['status'] == 3) {
                                $mod = '';
                                if ($saidastotal['destino'] > 500) {
                                  $mod = 'data-target="#excluir-consumo" title="Clique se deseja Excluír."';
                                }
                                echo '<button class="btn  tooltips-general"  style="color:#298A08" data-toggle="modal"' . $mod . '   onclick="excluirConsumo(' . $saidastotal['id_entrada'] . ',' . $saidastotal['qnt_saida'] . ',' . $saidastotal['id_saida'] . ')"><i class="glyphicon glyphicon-ok-sign"></i></button>';
                              };
                              ?>
                            </div>
      ...
      <div class="modal fade" id="excluir-consumo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
              ...
              <form method="post" action="">
                <div class="container-fluid text-center">
                  <div class="col-xs-12 col-sm-12 a">
                    ...
                    <input type="hidden" id="idsaida" name="idsaida">
                  </div>
                </div>
            </div>
            <div class="modal-footer">
              <p align="center">
                ...
                <button type="submit" class="btn btn-danger" name="excluir-consumo" title="excluir Registro"><i class="glyphicon glyphicon glyphicon-trash"></i> &nbsp;&nbsp; EXCLUIR</button>
              </p>
            </div>
            </form>
          </div>
