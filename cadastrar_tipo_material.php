...
<head>
    ...
    <title>Cadastro de Tipo de material</title>
...
<body overflow: hidden;">
    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Tipo de Material</small></h1>
            </div>
        </div>
        ...
        <div class='container-fluid'>
            <form method='POST' action='controller/tipo_material_controller.php'>
                <div class='row'>
                    <div class='col-xs-12 col-sm-6'>
                        <label>Descrição do Tipo Material</label>
                ...
                <div class='full-reset row representative-resul'>
                    <div class="col">
                        <center>
                            <input type='text' class='form-control text-center  tooltips-general' name='descr'
                                id='descr' data-toggle='tooltip' data-placement='top' title='Nome do tipo do documento'
                                required>
                            <br>
    ...
    <section id="direita">
        ...
        <table id="example" class="table table-striped col-md-12" align="center"
            ...
            <tbody>
                ...
                <?php
                foreach ($tipoMaterial as $listarMaterial) {
                ?>
                <tr>
                    <th scope="row"><?php echo $listarMaterial['id']; ?></th>
                    <td><?php
                            echo $listarMaterial['descr'];
                            ?></td>
                    <td>
                        <a href="cadastrar_tipo_material.php?editar=true&idEditar=<?php echo $listarMaterial['id']; ?>">
                            <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                            </button></a>
                    </td>
                    <td>
                        <a
                            href="controller/tipo_material_controller.php?deletar=true&id=<?php echo $listarMaterial['id']; ?>">
    ...
    $tipoMaterial = tipomaterial::consultar("SELECT * FROM tipomaterial WHERE ativo = 1 AND id = '$idEditar'");

    foreach ($tipoMaterial as $ttt) {
    ?>
    <!-- ATUALIZAR Material -->
    <div class='container-fluid'>
        <form method='post' action='controller/tipo_material_controller.php'>
            ...
            <div class='full-reset row representative-resul'>
                <div class="col">
                    <center>
                        ...
                        <input type='text' value="<?php echo $ttt['descr']; ?>"
                            class='form-control text-center  tooltips-general' name='descritivoAtualizado' id='descr'
                            data-toggle='tooltip' data-placement='top' title='Nome do tipo do material' required>
                        <?php } ?>
                        <br>
