...
<body overflow: hidden; ">
    ...
    include_once 'library/adiantamentofinanceiro.php';
    include_once 'library/licitacao.php';
    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Licitação</small></h1>
            </div>
        </div>
        ...
        <div class='container-fluid'>
            <form method='POST' action='controller/licitacao_controller.php'>
                ...
                <div class='full-reset row representative-resul'>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        ...
                        <div class='group-material'>
                            <input type='text' class=' form-control text-center tooltips-general' id='numero_ata'
                                name='numero_ata' data-toggle='tooltip' data-placement='top' title='Empenho'>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        <label>Quantidade ATA</label>
                        <div class='group-material'>
                            <input type='text' class=' form-control text-center tooltips-general' id='quantidade_ata'
                                name='quantidade_ata' data-toggle='tooltip' data-placement='top' title='Classe'
                                required>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        ...
                        <div class='group-material'>
                            <input type='date' step='0.01' class=' form-control text-center tooltips-general'
                                id='validade' name='validade' data-toggle='tooltip' data-placement='top' title='Classe'
                                required>
        ...
        <center>
            <div class="alert alert-secondary  col-md-12' role='alert' align='center">
                <h1>
                    <font color="black">Licitações Cadastradas</font>
            ...
            <table id="example" class="table table-striped col-md-12" align="center"
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">Quantidade ATA</th>
                ...
                <?php
                    $Licitacao = licitacao::consultar("SELECT * FROM licitacao WHERE ativo = 1");
                    ?>
                <tbody>

                    <?php
                        foreach ($Licitacao as $listarLicitacao) {
                        ?>
                    <tr>
                        <th scope="row"><?php echo $listarLicitacao['id']; ?></th>
                        <td><?php
                                    echo $listarLicitacao['descricao'];
                                    ?></td>

                        <td><?php
                                    echo $listarLicitacao['sei_processo'];
                                    ?></td>

                        <td><?php
                                    echo $listarLicitacao['numero_ata'];
                                    ?></td>

                        <td><?php
                                    echo $listarLicitacao['quantidade_ata'];
                                    ?></td>

                        <td><?php
                                    echo $listarLicitacao['validade'];
                                    ?></td>
                        <td>
                            <a
                                href="cadastrar_licitacao.php?editar=true&idEditar=<?php echo $listarLicitacao['id']; ?>">
                                <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                                </button></a>
                        </td>
                        <td>
                            <a
                                href="controller/licitacao_controller.php?deletar=true&id=<?php echo $listarLicitacao['id']; ?>">
        ...
        <?php
            ...
            $Licitacao = licitacao::consultar("SELECT * FROM licitacao WHERE ativo = 1 AND id = '$idEditar'");

            foreach ($Licitacao as $ttt) {
            ?>
        <!-- ATUALIZAR Material -->
        <div class='container-fluid'>
            <form method='post' action='controller/licitacao_controller.php'>
                        ...
                        <center>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <input type='text' value="<?php echo $ttt['descricao']; ?>"
                                    ...
                                    id='descricaoAtualizado' data-toggle='tooltip' data-placement='top'
                                    title='Nome da descrição' required>
                            </div>
                            <div class='col-sm-6'>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <input type='text' value="<?php echo $ttt['numero_ata']; ?>"
                                    class='form-control text-center  tooltips-general' name='numero_ataAtualizado'
                                    id='numero_ataAtualizado' data-toggle='tooltip' data-placement='top'
                                    title='Nome da descrição' required>
                            </div>

                            <div class='col-sm-6'>
                                <label>Quantidade ATA</label>
                                <input type='text' value="<?php echo $ttt['quantidade_ata']; ?>"
                                    class='form-control text-center  tooltips-general' name='quantidade_ataAtualizado'
                                    id='quantidade_ataAtualizado' data-toggle='tooltip' data-placement='top'
                                    title='Nome da descrição' required>
                            </div>

                            <div class='col-sm-6'>
                                <label>Validade</label>
                                <input type='date' value="<?php echo $ttt['validade']; ?>"
                                    class='form-control text-center  tooltips-general' name='validadeAtualizado'
                                    id='validadeAtualizado' data-toggle='tooltip' data-placement='top'
                                    title='Nome da descrição' required>
                            </div>
