...
<head>
    ...
    <title>Cadastro de Tipo de Saída</title>
...
<body overflow: hidden;">
    ...
    include_once 'library/tiposaida.php';
    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Tipo de Saída
            </div>

            <?php if (!isset($_REQUEST['editar'])) { ?>

            <div class='container-fluid'>
                <form method='POST' action='controller/tipo_saida_controller.php'>
            ...
            <center>
                <div class="alert alert-secondary  col-md-12" role="alert" align="center">
                    <h1>
                        <font color="black">Tipos de Saídas Cadastradas</font>
                    </h1>
                </div>
            </center>
            ...
            <section id="direita">
                ...
                <table id="example" class="table table-striped col-md-12" align="center"
                    ...
                    <?php
                        $Tiposaida = tiposaida::consultar("SELECT * FROM tiposaida WHERE ativo = 1");
                        ?>
                    <tbody>

                        <?php
                            foreach ($Tiposaida as $listartiposaida) {
                            ?>
                        <tr>
                            <th scope="row"><?php echo $listartiposaida['id']; ?></th>
                            <td><?php
                                        echo $listartiposaida['descricao'];
                                        ?></td>


                            <td>
                                <a
                                    href="cadastrar_tipo_saida.php?editar=true&idEditar=<?php echo $listartiposaida['id']; ?>">
                                    <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp;
                                        Editar
                                    </button></a>
                            </td>
                            <td>
                                <a
                                    href="controller/tipo_saida_controller.php?deletar=true&id=<?php echo $listartiposaida['id']; ?>">
            ...
            <?php
                ...
                $Tiposaida = tiposaida::consultar("SELECT * FROM tiposaida WHERE ativo = 1 AND id = '$idEditar'");

                foreach ($Tiposaida as $ttt) {
                ?>
            <!-- ATUALIZAR Material -->
            <div class='container-fluid'>
                <form method='post' action='controller/tipo_saida_controller.php'>
                    <div class='row'>
                        <div class='col-xs-12 col-sm-6'>
                            <label>Descrição do Tipo de Saída</label>
