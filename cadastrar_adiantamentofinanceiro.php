    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Adiantamentos Financeiros</small></h1>
            </div>
        </div>
        ...
        <div class='container-fluid'>
            <form method='POST' action='controller/adiantamentofinanceiro_controller.php'>
        ...
        <center>
            <div class="alert alert-secondary  col-md-12" role="alert" align="center">
                <h1>
                    <font color="black">Adiantamentos Financeiros Cadastrados</font>
                </h1>
            </div>
        </center>
        ...
        <section id="direita">
            ...
            <table id="example" class="table table-striped col-md-12" align="center"
                ...
                <?php
                    $Adiantamentofinanceiro = adiantamentofinanceiro::consultar("SELECT * FROM adiantamentofinanceiro WHERE ativo = 1");
                    ?>
                <tbody>

                    <?php
                        foreach ($Adiantamentofinanceiro as $listaradiantamentofinanceiro) {
                        ?>
                    <tr>
                        <th scope="row"><?php echo $listaradiantamentofinanceiro['id']; ?></th>
                        <td><?php
                                    echo $listaradiantamentofinanceiro['descricao'];
                                    ?></td>

                        <td><?php
                                    echo $listaradiantamentofinanceiro['sei_processo'];
                                    ?></td>
                        <td>
                            <a
                                href="cadastrar_adiantamentofinanceiro.php?editar=true&idEditar=<?php echo $listaradiantamentofinanceiro['id']; ?>">
                                <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                                </button></a>
                        </td>
                        <td>
                            <a
                                href="controller/adiantamentofinanceiro_controller.php?deletar=true&id=<?php echo $listaradiantamentofinanceiro['id']; ?>">
        ...
        <?php
            ...
            $Adiantamentofinanceiro = adiantamentofinanceiro::consultar("SELECT * FROM adiantamentofinanceiro WHERE ativo = 1 AND id = '$idEditar'");

            foreach ($Adiantamentofinanceiro as $ttt) {
            ?>
        <!-- ATUALIZAR Material -->
        <div class='container-fluid'>
            <form method='post' action='controller/adiantamentofinanceiro_controller.php'>
