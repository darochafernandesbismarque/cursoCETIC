...
<body>
  ...
  <div class="content-page-container full-reset custom-scroll-containers">
    ...
    $qryentrada = "SELECT m.descricao,qnt,data,f.descricao as fornecedor,vl_uni,vl_total,nf,status,rg_status,obs,user, id_entrada,id_material,validade FROM entrada e,material m,fornecedor f WHERE data BETWEEN '$datainic' AND '$datafim' $idMaterialEntrada  $fornecedor $tipoverba and e.id_material=m.id and opm='$opm_logado' and id_fornecedor=f.id  order by e.id desc";
    ...
    $qrysaida = "SELECT * FROM saida s,material m, tabopm o WHERE data_saida BETWEEN '$datainic' AND '$datafim' and opm='$origem' $destino  $idMaterialSaida and s.id_material_saida=m.id and s.destino=o.cod_opm  order by id_saida desc";
