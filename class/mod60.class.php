...
session_start();
	...
	class modelo60{
	 	...
	 	public	function listaMateriais($numero){
	 		...
	 		$query = "SELECT s.status,s.user_saida,s.destino,documento,dt_doc,t.descritivo,s.status,rg_retirada,valor_individual,data_saida,m60,abrev_opm,m.descricao,
				s.ult_estoque, s.qnt_saida,u.descricao as unidade
				FROM saida s,material m, tabopm o,unid_medida u,tipodoc t 
				WHERE m60='$numero' and s.id_material_saida=m.id and s.destino=o.cod_opm and u.id=m.medida and t.id=s.tipo_doc";
