...
<head>
    ...
    <title>Cadastro Tipo de Documento</title>
...
<body overflow: hidden;">
    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Tipo de Documento</small></h1>
            </div>
        </div>
        ...
        <div class='container-fluid'>
            <form method='POST' action='controller/tipo_documento_controller.php'>
                <div class='row'>
                ...
                <div class='full-reset row representative-resul'>
                    <div class="col">
                        <center>
                            <input type='text' class='form-control text-center  tooltips-general' name='descritivo'
                                id='descritivo' data-toggle='tooltip' data-placement='top'
                                title='Nome do tipo do documento' required>
                            <br>
    ...
    <center>
        <div class="alert alert-secondary  col-md-12" role="alert" align="center">
            <h1>
                <font color="black">Documentos Cadastrados</font>
            </h1>
        </div>
    </center>
    ...
    <section id="direita">
        ...
        <table id="example" class="table table-striped col-md-12" align="center"
            ...
            <?php
            $tipoDocumento = tipodocumento::consultar("SELECT * FROM tipodocumento WHERE ativo = 1");
            ?>
            <tbody>

                <?php
                foreach ($tipoDocumento as $listarDocumento) {
                ?>
                <tr>
                    <th scope="row"><?php echo $listarDocumento['id']; ?></th>
                    <td><?php
                            echo $listarDocumento['descritivo'];
                            ?></td>
                    <td>
                        <a
                            href="cadastrar_tipo_documento.php?editar=true&idEditar=<?php echo $listarDocumento['id']; ?>">
                            <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                            </button></a>
                    </td>
                    <td>
                        <a
                            href="controller/tipo_documento_controller.php?deletar=true&id=<?php echo $listarDocumento['id']; ?>">
    ...
    $tipoDocumento = tipodocumento::consultar("SELECT * FROM tipodocumento WHERE ativo = 1 AND id = '$idEditar'");

    foreach ($tipoDocumento as $ttt) {
    ?>
    <!-- ATUALIZAR DOCUMENTO -->
    <div class='container-fluid'>
        <form method='post' action='controller/tipo_documento_controller.php'>
            ...
            <div class='full-reset row representative-resul'>
                <div class="col">
                    <center>
                        ...
                        <input type='text' value="<?php echo $ttt['descritivo']; ?>"
                            class='form-control text-center  tooltips-general' name='descritivoAtualizado'
                            id='descritivo' data-toggle='tooltip' data-placement='top' title='Nome do tipo do documento'
                            required>
                        <?php } ?>
                        <br>
