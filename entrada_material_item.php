            ...
            <form method='post' action='controller/entrada_material_item_controller.php'>
                <div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-4'>
                        ...
                        <div class='group-material'>
                            <input type='date' class='selectpicker  form-control text-center tooltips-general'
                                name='validade' id='validade' maxlength='20' data-toggle='tooltip' value='25/09/2020'
                                data-placement='top' title='Data do Documento' required>
                        </div>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-4'>
                        <label>Lote</label>
                        <div class='group-material'>
                            <input type="text" class=' form-control text-center tooltips-general' name="lote" value="">
                ...
                <div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-4'>
                        ...
                        <div class='group-material'>
                            <input type="text" class=' form-control text-center tooltips-general' name="valor_unitario"
                                value="" onKeyPress="return(moeda(this,'.','.',event))">
                    ...
                    <div class='row'>
                        ...
                        <div class="col-sm-3'">
                            <div class="alert alert-primary" role="alert"
                                ...
                                ?>
                            <input type="hidden" id="valor_total" value="<?php echo number_format($valortotal, 2, ',', '.') ?>"
                            </div>
                        </div>
