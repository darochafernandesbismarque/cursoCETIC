    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Tipo de Entrada
            </div>

            <?php if (!isset($_REQUEST['editar'])) { ?>

            <div class='container-fluid'>
                <form method='POST' action='controller/tipo_entrada_controller.php'>
            ...
            <center>
                <div class="alert alert-secondary  col-md-12" role="alert" align="center">
                    <h1>
                        <font color="black">Tipos de Entradas Cadastradas</font>
                    </h1>
                </div>
            </center>
            ...
            <section id="direita">
                ...
                <table id="example" class="table table-striped col-md-12" align="center"
                    ...
                    <?php
                        $Tipoentrada = tipoentrada::consultar("SELECT * FROM tipoentrada WHERE ativo = 1");
                        ?>
                    <tbody>

                        <?php
                            foreach ($Tipoentrada as $listartipoentrada) {
                            ?>
                        <tr>
                            <th scope="row"><?php echo $listartipoentrada['id']; ?></th>
                            <td><?php
                                        echo $listartipoentrada['descricao'];
                                        ?></td>


                            <td>
                                <a
                                    href="cadastrar_tipo_entrada.php?editar=true&idEditar=<?php echo $listartipoentrada['id']; ?>">
                            ...
                            <td>
                                <a
                                    href="controller/tipo_entrada_controller.php?deletar=true&id=<?php echo $listartipoentrada['id']; ?>">
            ...
            <?php
                ...
                $Tipoentrada = tipoentrada::consultar("SELECT * FROM tipoentrada WHERE ativo = 1 AND id = '$idEditar'");

                foreach ($Tipoentrada as $ttt) {
                ?>
            <!-- ATUALIZAR Material -->
            <div class='container-fluid'>
                <form method='post' action='controller/tipo_entrada_controller.php'>
                    <div class='row'>
                        <div class='col-xs-12 col-sm-6'>
                            <label>Descrição do Tipo de Entrada</label>
