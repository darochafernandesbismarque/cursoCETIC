...
<head>
    ...
    <title>Cadastro de Unidades USB</title>
    ...
    <div class='content-page-container full-reset custom-scroll-containers'>
        ...
        <div class='container'>
            <div class='page-header'>
                <h1 class='all-tittles'>SisMatOdonto <small> Cadastrar Unidade de Saúde Básica</small></h1>
            </div>
        </div>
                ...
                <div class='full-reset row representative-resul'>
                    ...
                    <div class='col-xs-12 col-sm-6'>
                        ...
                        <div class='group-material'>
                            <input type='text' class='form-control text-center  tooltips-general' name='abreviacao'
                                id='abreviacao' data-toggle='tooltip' data-placement='top'
        ...
        <center>
            <div class="alert alert-secondary  col-md-12" role="alert" align="center">
                <h1>
                    <font color="black">USB Cadastradas</font>
                </h1>
            </div>
        </center>
        ...
        <section id="direita">
            ...
            <table id="example" class="table table-striped col-md-12" align="center"
                ...
                <?php
                    $Usb = usb::consultar("SELECT * FROM usb WHERE ativo = 1");
                    ?>
                <tbody>

                    <?php
                        foreach ($Usb as $listarUsb) {
                        ?>
                    <tr>
                        <th scope="row"><?php echo $listarUsb['id']; ?></th>
                        <td><?php
                                    echo $listarUsb['descricao'];
                                    ?></td>

                        <td><?php
                                    echo $listarUsb['abreviacao'];
                                    ?></td>
                        <td>
                            <a href="cadastrar_unidades_usb.php?editar=true&idEditar=<?php echo $listarUsb['id']; ?>">
                                <button type="" class="btn btn-warning"><i class="fas fa-user-edit"></i>&nbsp; Editar
                                </button></a>
                        </td>
                        <td>
                            <a href="controller/usb_controller.php?deletar=true&id=<?php echo $listarUsb['id']; ?>">
        ...
        <?php
            ...
            $Usb = usb::consultar("SELECT * FROM usb WHERE ativo = 1 AND id = '$idEditar'");

            foreach ($Usb as $ttt) {
            ?>
        <!-- ATUALIZAR Material -->
        <div class='container-fluid'>
            <form method='post' action='controller/usb_controller.php'>
                <div class='row'>
                    <div class='col-xs-12 col-sm-6'>
                    ...
                    <div class="col">
                        <center>
                            ...
                            <div class='col-sm-6'>
                                ...
                                <label>Abreviação</label>
                                <input type='text' value="<?php echo $ttt['abreviacao']; ?>"
                                    class='form-control text-center  tooltips-general' name='abreviacaoAtualizado'
                                    id='abreviacao' data-toggle='tooltip' data-placement='top'
                                    title='Nome da abreviação' required>
